...
public static void main(String[] args) throws InterruptedException {
    ...
    driver.findElement(By.id("Campaigns_editView_fieldName_campaignname")).sendKeys("parag");
	...
	driver.findElement(By.id("Campaigns_editView_fieldName_sponsor")).sendKeys("Parag");
