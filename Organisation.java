...
public static void main(String[] args) throws InterruptedException {
    ...
    driver.findElement(By.id("Accounts_editView_fieldName_accountname")).sendKeys("parag");
    driver.findElement(By.id("Accounts_editView_fieldName_website")).sendKeys("https://www.DSIndustries.in");
    driver.findElement(By.id("Accounts_editView_fieldName_phone")).sendKeys("7020138004");
    driver.findElement(By.id("Accounts_editView_fieldName_tickersymbol")).sendKeys("Diggs");
    ...
    driver.findElement(By.id("Accounts_editView_fieldName_email1")).sendKeys("parag1065@gmail.com");
    ...
    driver.findElement(By.id("Accounts_editView_fieldName_otherphone")).sendKeys("8007535491");
    driver.findElement(By.id("Accounts_editView_fieldName_employees")).sendKeys("10");
    driver.findElement(By.id("Accounts_editView_fieldName_email1")).sendKeys("parag6@gmail.com");
    driver.findElement(By.id("Accounts_editView_fieldName_email2")).sendKeys("parag88@gmail.com");
...
//    Thread.sleep(2000);
    driver.findElement(By.name("bill_street")).sendKeys("Ganesh Nakshtram Dhayari Dsk");
    ...
    driver.findElement(By.id("Accounts_editView_fieldName_ship_state")).sendKeys("pune");
